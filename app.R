...
elsa_file_2= "Data/SZ_Diabetes_SELF_imputed_for_prediction_PhDStudy3.csv"
...
server <- function(input, output) {
    ...
    switch(input$data_type,
           ...
           "Simulated: Non PH" =  
             simulatedata_lin_nonPH(input$N,
                                    ...
                                    percentcensored = 1- input$percent_censored_inv,
                                    drop_out = input$drop_out_rate),
           "ELSA_Diabetes_Study2" = read.csv(elsa_file_2),
  ...
  predictfactors <- reactive({
    switch(input$data_type,
           ...
           "ELSA_Diabetes_Study2" = c("sz20_", "pc1_", "pc2_", "pc3_", "pc4_", "age_", 
                                     "sex", "bmi_0_", "hyp_0", "cvd_0", "B_dep_0", 
                                     "trig_0", "baseline_hdl", "stroke_0", "B_smokstatus_0", 
                                     "exercise_light", "exercise_vig", "EduLevel_low",
                                     "EduLevel_med", "wealth_med", "wealth_low", "t2dm_"),
           "Foot_Ulcer_Study"  = c("age", "sex", "texsev", "mean_hbamva",
