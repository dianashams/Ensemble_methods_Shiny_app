...
method_1A_cv = function(df, predict.factors, 
                        fixed_time = NaN, 
                        cv_number = 3,
                        internal_cv_k = 3, 
                        seed_to_fix = 100,
...
method_1B_cv = function(df, predict.factors, 
                        fixed_time = NaN, cv_number = 3, 
                        inner_cv=3,
                        seed_to_fix = 100,
                        pretrained_srf_models = NULL,
                        verbose = FALSE,
                        useCoxLasso = FALSE){
  time_0 = Sys.time()
  set.seed(seed_to_fix)
...
method_2A_train = function(df_train, predict.factors, 
                           fixed_time= NaN, 
                           inner_cv =3, seed_to_fix = 100, 
                           verbose = FALSE,
                           useCoxLasso = FALSE, 
                           var_importance = NULL){
...
method_3_train = function(df_train, predict.factors, 
                          fixed_time=NaN, 
                          inner_cv = 3, 
                          seed_to_fix = 100,
                          useCoxLasso = FALSE, 
...
method_3_cv = function(df, predict.factors, 
                       fixed_time = NaN,
                       cv_number = 3, 
                       inner_cv =3, 
                       seed_to_fix = 100,
